...
(function (project) {
    ...
    var MainLayer = (function (_super) {
        ...
        function MainLayer() {
            ...
            this.addEventListener("pressmove", function (event) { return _this.pressMoveHandler(event); });
        ...
        MainLayer.prototype.pressMoveHandler = function (event) {
            // 5フレームに1回処理
...
//# sourceMappingURL=particleCreatorForIOS.js.map